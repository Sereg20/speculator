...
export const DEFECT_TYPES = {
  ...
  DENT_MAJOR:          { id: 'dent_major',           category: 'body',         severity: 'major' },
  ...
  // Engine
  OIL_LEAK:            { id: 'oil_leak',             category: 'engine',       severity: 'major' },
  COOLANT_LEAK:        { id: 'coolant_leak',         category: 'engine',       severity: 'major' },
  WORN_BELTS:          { id: 'worn_belts',           category: 'engine',       severity: 'major' },
  ...
  STARTING_ISSUES:     { id: 'starting_issues',      category: 'engine',       severity: 'major' },
  SMOKE_EXHAUST:       { id: 'smoke_exhaust',        category: 'engine',       severity: 'major' },

  // Transmission
  SLIPPING_GEARS:      { id: 'slipping_gears',       category: 'transmission', severity: 'major' },
  FLUID_LEAK_GEARBOX:  { id: 'fluid_leak_gearbox',  category: 'transmission', severity: 'major' },
  CLUTCH_WEAR:         { id: 'clutch_wear',          category: 'transmission', severity: 'major' },
  ROUGH_SHIFTING:      { id: 'rough_shifting',       category: 'transmission', severity: 'minor' },
  DIFF_NOISE:          { id: 'diff_noise',           category: 'transmission', severity: 'major' },

  // Suspension
  WORN_SHOCKS:         { id: 'worn_shocks',          category: 'suspension',   severity: 'minor' },
  WORN_BALL_JOINTS:    { id: 'worn_ball_joints',     category: 'suspension',   severity: 'major' },
  ...
  FAULTY_AC:           { id: 'faulty_ac',            category: 'interior',     severity: 'major' },
  ...
  FAULTY_ALTERNATOR:   { id: 'faulty_alternator',   category: 'electrics',    severity: 'major' },
  WIRING_ISSUES:       { id: 'wiring_issues',        category: 'electrics',    severity: 'major' },
  FAULTY_SENSORS:      { id: 'faulty_sensors',       category: 'electrics',    severity: 'minor' },
  ABS_FAULT:           { id: 'abs_fault',            category: 'electrics',    severity: 'major' },
