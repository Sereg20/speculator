  ...
  switch (contextType) {
    ...
    case 'seller_negotiate_counter': {
      ...
      return (
        ...
        `Напиши ОДНУ реплику продавца — он торгуется, называет встречную цену цифрами. Цена указана числом, не словами. Разговорный стиль авторынка. Без кавычек, без мата.`
      );
    }
